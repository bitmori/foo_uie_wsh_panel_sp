...
public:
	...
	//STDMETHODIMP ShareInfo(UINT target, BSTR name, VARIANT info);
};
...
public:
	...
	STDMETHODIMP DrawThemeTextEx(IGdiGraphics * gr, BSTR text, VARIANT color, int x, int y, int w, int h,int iGlowSize, int format);
};
